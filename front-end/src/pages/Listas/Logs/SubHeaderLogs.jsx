...
const SubHeaderLogs = ({
  ...
  const printButtonTooltipPDF = <Tooltip id="pdf-tooltip">Imprimir PDF</Tooltip>;
  const printButtonTooltipExcel = <Tooltip id="excel-tooltip">Imprimir Excel</Tooltip>;
